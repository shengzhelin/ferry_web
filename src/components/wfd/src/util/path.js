...
module.exports = {
  ...
  /**
   * 根據起始點、相對位置、偏移量計算控制點
   * @param  {Object} startPoint 起始點，包含 x,y
   * @param  {Object} endPoint  結束點, 包含 x,y
   * @param  {Number} percent   相對位置,範圍 0-1
   * @param  {Number} offset    偏移量
   * @return {Object} 控制點，包含 x,y
   */
