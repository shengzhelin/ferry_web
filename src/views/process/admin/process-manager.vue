  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-table v-loading="loading" border :data="processValueList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="更新時間" align="center" prop="update_time" width="180" />
      ...
      <el-dialog :title="dialogProcessVisibleName===1?'新建流程':'編輯流程'" :visible.sync="open" :fullscreen="true" style="margin-top: 0">
        <div class="tpl-create-content">
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
            <el-row>
              <el-col :span="12">
                <el-form-item label="名稱" prop="name">
                  <el-input v-model="ruleForm.name" placeholder="請輸入流程名稱" style="width: 100%" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="分類" prop="classify">
                  <el-select v-model="ruleForm.classify" filterable placeholder="請選擇流程分類" style="width: 100%">
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item label="模版" prop="tpls">
                  <el-select v-model="ruleForm.tpls" filterable multiple placeholder="請選擇模版" style="width: 100%">
                    <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="通知">
                  <el-select v-model="ruleForm.notice" multiple filterable clearable placeholder="請選擇流程任務" style="width: 100%">
                    <el-option label="郵件" :value="1" />
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="任務">
                  <el-select v-model="ruleForm.task" multiple filterable clearable placeholder="請選擇流程任務" style="width: 100%">
                    <el-option
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        icon: [
          { required: true, message: '請輸入流程圖標', trigger: 'blur' }
        ],
        name: [
          { required: true, message: '請輸入流程名稱', trigger: 'blur' }
        ],
        classify: [
          { required: true, message: '請選擇流程分類', trigger: 'blur, change' }
        ],
        tpls: [
          { required: true, message: '請選擇模版', trigger: 'blur, change' }
        ],
        structure: [
          { required: true, message: '請設計流程', trigger: 'blur' }
        ],
        remarks: [
          { required: true, message: '請輸入流程描述', trigger: 'blur' }
        ]
      }
    }
  },
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (structureValue.nodes.length > 0 && structureValue.edges.length > 0) {
            ...
            this.$message.error('沒有流程數據，請完善流程')
          }
        }
      })
    },
