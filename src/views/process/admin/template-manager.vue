<template>
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-dialog :title="dialogFormVisibleName===1?'新建模版':'編輯模版'" :visible.sync="open" :fullscreen="true" style="margin-top: 0">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '請輸入模版名稱', trigger: 'blur' }
        ],
        form_structure: [
          { required: true, message: '請設計模版', trigger: 'blur' }
        ]
      }
    }
  },
