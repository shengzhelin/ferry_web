    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
          <el-form-item label="標題:" prop="title" style="margin-bottom: 13px">
            <el-input v-model="ruleForm.title" size="small" />
          </el-form-item>
          <el-form-item label="優先級:" prop="priority" style="margin-bottom: 0">
            <el-radio-group v-model="ruleForm.priority" size="small">
              <el-radio :label="1">一般</el-radio>
              <el-radio :label="2">緊急</el-radio>
              <el-radio :label="3">非常緊急</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-form>
      </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        priority: [
          { required: true, message: '請選擇工單優先級', trigger: 'blur' }
        ]
      },
      remoteFunc: {
        // 獲取用戶列表
