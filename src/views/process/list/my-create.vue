...
export default {
  ...
  methods: {
    ...
    handleUrge(row) {
      this.$confirm('<span style="font-size:15px ">對此工單處理人進行催辦通知提醒, 是否繼續?</span><br><span style="color: #c33; font-size: 10px">注意：十分鐘內只能催辦一次。</span>', '催辦', {
