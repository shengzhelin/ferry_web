    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px">
          ...
          <el-form-item label="系統Logo：" prop="logo">
            <el-upload
          ...
          <el-form-item style="margin-bottom: 0">
            <el-button v-permisaction="['system:settings:index:config']" type="primary" @click="submitForm('ruleForm', 1)">確定</el-button>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <el-card class="box-card" style="margin-top: 15px">
      ...
      <div class="text item">
        ...
        <div style="margin-top: 20px">
          <el-button v-permisaction="['system:settings:index:ldap']" type="primary" @click="submitForm('ruleForm', 2)">確定</el-button>
        </div>
      </div>
    </el-card>
  </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        logo: [
          { required: true, message: '請設置Logo', trigger: 'blur' }
        ]
      },
      tableData: []
    }
